 ...
 */
public class ViewTelaBackup extends javax.swing.JFrame {

    /**
     * Creates new form ViewTelaBackup
     */
    public ViewTelaBackup() {
        initComponents();
        setIcon();
    }
    public void setIcon(){
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/otimizacao.png"))); // NOI18N
        jButton1.setText("Criar Backup");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/enviar.png"))); // NOI18N
            ...
            if (result == JFileChooser.APPROVE_OPTION) {
                ...
                if (file.exists()) {
                    ...
                    if (opcao == JOptionPane.YES_OPTION) {
                        ...
                        bck.exec("C:/xampp/mysql/bin/mysqldump.exe -uroot --add-drop-database -B tecnoasus -r"+arquivo);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JFC_Backup.setFileFilter(new FileNameExtensionFilter("Arquivo de BD", "sql"));
        ...
        String user = "root";
        String pass = "";
        String[] restorecmd = new String[]{"C:/xampp/mysql/bin/mysql.exe", "--user=" + user, "--password=" + pass, "-e", "source " + arq};
        Process process;
        try {
            ...
            if (procCom == 0) {
                ...
                JOptionPane.showMessageDialog(null, "Falha na Restauração do Backup");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTelaBackup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewTelaBackup().setVisible(true);
            }
        });
    }
